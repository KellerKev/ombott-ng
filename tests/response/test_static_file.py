...
import pytest
import  ombott_ng
from ombott_ng import static_file, _Globals
from ombott_ng.static_stream import get_first_range
import wsgiref.util
...
basename2 = os.path.basename(ombott_ng.__file__)
root2 = os.path.dirname(ombott_ng.__file__)
